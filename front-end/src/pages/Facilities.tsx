...
const Facilities = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "Setup Required": return "text-red-600 bg-red-50 border-red-200";
    ...
    <Card className="text-center py-16">
      <CardContent>
        ...
        <p className="text-gray-600 mb-8 max-w-md mx-auto">
          Start managing your emergency preparedness by adding your first facility. You can set up emergency plans, assign people, and track compliance.
        </p>
        <Button onClick={() => navigate("/create-facility")} size="lg" className="flex items-center gap-2 mx-auto">
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage your organization's facilities and emergency plans</p>
        </div>
        {facilities.length > 0 && (
                ...
                <CardContent className="space-y-3">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="font-semibold">{currentOccupancy}/{maxOccupancy}</div>
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className={`font-bold ${getComplianceColor(0)}`}>
                        0%
                      </div>
                    </div>
                  </div>
