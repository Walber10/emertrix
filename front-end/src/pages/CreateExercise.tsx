...
const CreateExercise = () => {
  ...
  const emergencyProcedures = emergencyPlan?.procedureIds?.map(procedureId => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.exerciseType || !formData.selectedProcedureId || !formData.proposedDate || !formData.proposedTime || !formData.location || !formData.coordinator) {
      toast({
    ...
    try {
      ...
      toast({
        ...
        description: "The emergency exercise has been scheduled and will appear in upcoming exercises.",
      });
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                Suggested: Fire Drill, Evacuation Exercise, Medical Emergency Drill, Lockdown Exercise, Severe Weather Response, Bomb Threat Response
              </p>
            </div>

            <div className="space-y-2">
              <Label htmlFor="objectives" className="text-sm font-medium">Exercise Objectives (Optional)</Label>
              <Textarea
                id="objectives"
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.selectedProcedureId} onValueChange={(value) => setFormData(prev => ({ ...prev, selectedProcedureId: value }))}>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder={emergencyProcedures.length > 0 ? "Choose from existing procedures to indicate which one is being tested" : "No emergency procedures created yet"} />
                </SelectTrigger>
                <SelectContent>
              ...
              <p className="text-xs text-gray-500">
                For future compliance tracking
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="proposedTime" className="text-sm font-medium">Proposed Time *</Label>
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.coordinator} onValueChange={(value) => setFormData(prev => ({ ...prev, coordinator: value }))}>
                <SelectTrigger className="w-full">
          ...
          <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-sm text-green-800">
              <strong>Note:</strong> Once scheduled, the exercise will appear on the facility's Individual Facility page as an upcoming exercise, 
              with options to edit, cancel, or mark as completed.
            </p>
          </div>
        </CardContent>
      </Card>
