        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              You need to create a facility first before setting up the Emergency Planning
              Committee.
            </p>
            <Button
    ...
    <div className="p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Responsible for overseeing emergency management activities and ensuring all components
            are developed, maintained, and reviewed as required.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 mb-4">
              Start by adding members to your Emergency Planning Committee
            </p>
            <Button>
