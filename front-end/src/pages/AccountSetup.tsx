...
import { Building2, User, Mail, Lock, MapPin, Phone, UserPlus, Trash2, Check, ChevronRight, ChevronLeft } from "lucide-react";
...
const AccountSetup = () => {
  ...
  const [selectedPlanLocal, setSelectedPlanLocal] = useState<string | null>(onboarding.plan?.tier || null);
  ...
  const handleNextStep = () => {
    if (step === 1) {
      ...
      const missingUserFields = requiredUserFields.filter(field => !field.field || field.field.trim() === "");
  ...
  const handleComplete = () => {
    // Save all data to onboarding state
    updateState({
      organization: {
  ...
  const getStepTitle = () => {
    switch(step) {
      case 1: return "Organisation Details";
      case 2: return "User Details";
      case 3: return "Invite Additional Admins";
      case 4: return "Select Your Plan";
  ...
  const getStepDescription = () => {
    switch(step) {
      case 1: return "Provide your organisation's details to set up its primary account.";
      case 2: return "User setup captures the details of the primary account holder and assigns them as the default admin for the organisation.";
      case 3: return "Optional functionality to add and invite additional admin users during setup.";
      case 4: return "Choose the plan that best fits your organization's needs";
      case 5: return "Please review your information before completing setup.";
      default: return "";
    }
  };
            ...
            <CardContent className="p-8">
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="md:col-span-2">
                      <Label htmlFor="orgName" className="text-[#0E093D] font-light text-lg">Organisation Name *</Label>
                      <Input
                        id="orgName"
                    ...
                    <div className="md:col-span-2">
                      <Label htmlFor="address" className="text-[#0E093D] font-light text-lg">Address *</Label>
                      <Input
                        id="address"
                    ...
                    <div>
                      <Label htmlFor="phone" className="text-[#0E093D] font-light text-lg">Phone Number *</Label>
                      <Input
                        id="phone"
                    ...
                    <div>
                      <Label htmlFor="industry" className="text-[#0E093D] font-light text-lg">Industry *</Label>
                      <select
                        id="industry"
                    ...
                    <div>
                      <Label htmlFor="natureOfWork" className="text-[#0E093D] font-light text-lg">Nature of Work</Label>
                      <Input
                        id="natureOfWork"
                    ...
                    <div>
                      <Label htmlFor="orgSize" className="text-[#0E093D] font-light text-lg">Organisation Size *</Label>
                      <select
                        id="orgSize"
                        className="flex h-12 w-full rounded-md border border-gray-300 bg-background px-3 py-2 text-sm mt-2 focus:border-[#FF6500] focus:ring-[#FF6500]"
                    ...
                    <div>
                      <Label htmlFor="abn" className="text-[#0E093D] font-light text-lg">ABN</Label>
                      <Input
                        id="abn"
                        value={formData.abn}
              ...
              {step === 2 && (
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <Label htmlFor="firstName" className="text-[#0E093D] font-light text-lg">First Name *</Label>
                      <Input
                        id="firstName"
                    ...
                    <div>
                      <Label htmlFor="lastName" className="text-[#0E093D] font-light text-lg">Last Name *</Label>
                      <Input
                        id="lastName"
                    ...
                    <div>
                      <Label htmlFor="password" className="text-[#0E093D] font-light text-lg">Password *</Label>
                      <Input
                        id="password"
                        type="password"
                    ...
                    <div>
                      <Label htmlFor="confirmPassword" className="text-[#0E093D] font-light text-lg">Confirm Password *</Label>
                      <Input
                        id="confirmPassword"
                        type="password"
                    ...
                    <div>
                      <Label htmlFor="userPhone" className="text-[#0E093D] font-light text-lg">Phone Number</Label>
                      <Input
                        id="userPhone"
                    ...
                    <div>
                      <Label htmlFor="email" className="text-[#0E093D] font-light text-lg">Email *</Label>
                      <Input
                        id="email"
                        type="email"  
                    ...
                    <div className="md:col-span-2">
                      <Label htmlFor="jobTitle" className="text-[#0E093D] font-light text-lg">Role / Job Title</Label>
                      <Input
                        id="jobTitle"
                    ...
                    <div className="md:col-span-2">
                      <Label htmlFor="profilePicture" className="text-[#0E093D] font-light text-lg">Profile Picture <span className="text-gray-500">(optional)</span></Label>
                      <Input
                        id="profilePicture"
                        type="file"
                        accept="image/*"
              ...
              {step === 3 && (
                <div className="space-y-8">
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 space-y-6 bg-gray-50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <Label htmlFor="inviteFirstName" className="text-[#0E093D] font-light text-lg">First Name</Label>
                        <Input
                          id="inviteFirstName"
                      ...
                      <div>
                        <Label htmlFor="inviteLastName" className="text-[#0E093D] font-light text-lg">Last Name</Label>
                        <Input
                          id="inviteLastName"
                      ...
                      <div className="md:col-span-2">
                        <Label htmlFor="inviteEmail" className="text-[#0E093D] font-light text-lg">Email Address</Label>
                        <Input
                          id="inviteEmail"
                          type="email"
                      ...
                      <div className="md:col-span-2">
                        <Label htmlFor="inviteJobTitle" className="text-[#0E093D] font-light text-lg">Job Title</Label>
                        <Input
                          id="inviteJobTitle"
                    ...
                    <Button onClick={addInvitedAdmin} className="w-full h-12 bg-[#FF6500] hover:bg-[#FF6500]/90 text-white">
                  ...
                  {invitedAdmins.length > 0 && (
                    <div>
                      <h4 className="font-semibold text-lg text-[#0E093D] mb-6">Invited Admins ({invitedAdmins.length})</h4>
                      <div className="space-y-4">
                        {invitedAdmins.map((admin) => (
                          <div key={admin.id} className="flex items-center justify-between p-4 border rounded-xl bg-white shadow-sm">
                            <div>
                              <p className="font-semibold text-[#0E093D]">{admin.firstName} {admin.lastName}</p>
                  ...
                  {plans.map((plan) => (
                    ...
                    >
                      ...
                      <CardHeader className="text-center pb-4 flex-shrink-0">
                        <CardTitle className={`text-lg font-bold mb-2 ${plan.id === 'enterprise' ? 'text-white' : 'text-[#0E093D]'}`}>
                          {plan.name}
                        </CardTitle>
                        <div className={`mb-2 ${plan.id === 'enterprise' ? 'text-white' : 'text-[#FF6500]'}`}>
                          <span className="text-2xl font-bold">{plan.price}</span>
                          <div className={`text-xs ${plan.id === 'enterprise' ? 'text-gray-300' : 'text-gray-500'}`}>
                            {plan.period}
                          </div>
                        </div>
                        <CardDescription className={`text-xs ${plan.id === 'enterprise' ? 'text-gray-300' : 'text-gray-600'}`}>
                          {plan.description}
                        </CardDescription>
                      </CardHeader>
                      ...
                      <CardContent className="flex-1 flex flex-col justify-between p-4 pt-0">
                        <div className="space-y-4">
                          <div>
                            <h4 className={`font-semibold text-xs mb-2 ${plan.id === 'enterprise' ? 'text-white' : 'text-[#0E093D]'}`}>
                              INCLUSIONS
                            </h4>
                            <ul className="space-y-1">
                              {plan.inclusions.map((inclusion, index) => (
                                <li key={index} className="flex items-center text-xs">
                                  <Check className={`h-3 w-3 mr-2 flex-shrink-0 ${plan.id === 'enterprise' ? 'text-green-400' : 'text-green-500'}`} />
                                  <span className={plan.id === 'enterprise' ? 'text-gray-200' : 'text-gray-700'}>
                                    {inclusion}
                                  </span>
                                </li>
                              ))}
                        ...
                        >
                          {selectedPlanLocal === plan.id ? 'Selected' : plan.id === 'enterprise' ? 'Contact Sales' : 'Select Plan'}
                        </Button>
                      </CardContent>
                    </Card>
                  ))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="p-6 bg-orange-50 rounded-xl border border-orange-200">
                      ...
                      <p className="text-gray-700 font-medium">
                        {plans.find(p => p.id === selectedPlanLocal)?.name} - {plans.find(p => p.id === selectedPlanLocal)?.price}
                      </p>
                    </div>
                    <div className="p-6 bg-gray-50 rounded-xl border border-gray-200">
                      ...
                      <div className="space-y-2 text-gray-700">
                        ...
                        <p>{formData.address}, {formData.city}, {formData.state} {formData.postcode}</p>
                      </div>
                    </div>
                    ...
                    {invitedAdmins.length > 0 && (
                      <div className="p-6 bg-yellow-50 rounded-xl border border-yellow-200">
                        <h4 className="font-semibold text-lg text-[#0E093D] mb-4">Additional Admins ({invitedAdmins.length})</h4>
                        {invitedAdmins.map((admin) => (
