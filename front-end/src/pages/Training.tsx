...
const Training = () => {
  ...
  const { appData, getTrainingCoursesByFacility, getFacilityById } = useApp();
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <Button onClick={() => navigate('/training-overview')} variant="outline">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Button onClick={() => navigate('/training-overview')} variant="outline" size="sm">
